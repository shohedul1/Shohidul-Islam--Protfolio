    ...
    <div className='bg-white fixed top-o w-[100%] z-10'>
        <div className='container mx-auto flex justify-between items-center py-4 px-4'>
            ...
            <div className='hidden md:flex gap-6'>
                ...
                <Link href="/about"><p className='hover:text-[#ff4D41]'>About</p></Link>
                <Link href="/protfolio"><p className='hover:text-[#ff4D41]'>Protfolio</p></Link>
                <Link href="/blog"><p className='hover:text-[#ff4D41]'>Blog</p></Link> 
                <Link href="/contact"><p className='hover:text-[#ff4D41]'>Contact</p></Link> 
            </div>
